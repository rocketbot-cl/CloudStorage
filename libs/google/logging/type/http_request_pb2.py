...
from google.r_protobuf import duration_pb2 as google_dot_r_protobuf_dot_duration__pb2
...
_HTTPREQUEST.fields_by_name[
    "latency"
].message_type = google_dot_r_protobuf_dot_duration__pb2._DURATION
