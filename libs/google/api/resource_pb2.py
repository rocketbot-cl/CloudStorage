...
google_dot_r_protobuf_dot_descriptor__pb2.FieldOptions.RegisterExtension(
    resource_reference
)
resource_definition.message_type = _RESOURCEDESCRIPTOR
google_dot_r_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(
    resource_definition
)
resource.message_type = _RESOURCEDESCRIPTOR
google_dot_r_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(resource)
